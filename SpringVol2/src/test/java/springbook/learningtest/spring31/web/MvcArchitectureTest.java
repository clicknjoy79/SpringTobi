...
public class MvcArchitectureTest extends AbstractDispatcherServletTest {
    ...
    public void oldArchitecture() throws ServletException, IOException {
        ...
        assertThat(getBean(SimpleInterceptor.class).handler, is(instanceOf(SimpleController.class)));
    }
    ...
    public void newArchitecture() throws ServletException, IOException {
        ...
        assertThat(getBean(SimpleInterceptor.class).handler, is(instanceOf(HandlerMethod.class)));
    }

    @Controller
    static class SimpleController {
        @RequestMapping("/hello")
        public String hello(@RequestParam Model model) { return "hello.jsp"; }
    }
    ...
    static class WebConfig extends WebMvcConfigurationSupport {
        ...
        @Bean HandlerInterceptor handlerInterceptor() { return new SimpleInterceptor(); }
    }
    ...
    @Configuration
    static class JobWebConfig extends WebMvcConfigurationSupport {
        @Override
        protected void addInterceptors(InterceptorRegistry registry) {
            registry.addInterceptor(handlerInterceptor());
        }

        @Bean HandlerInterceptor handlerInterceptor() { return new AuditInterceptor(); }
    }
    ...
    @Controller static class JobController {
        @RequestMapping("/hello")
    ...
    @Test
    public void defaultStategies() throws ServletException {
        setRelativeLocations("web/servlet.xml");
