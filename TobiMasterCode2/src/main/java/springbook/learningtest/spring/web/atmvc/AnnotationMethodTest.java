...
//		request.setCookies(new Cookie("auth", "ABCD"));
	...
	public void autoAddedModel() throws ServletException, IOException {
		...
		assertModel("mesg", "hi");	// �ڵ���� command model
		assertModel("string", "string");	// �ڵ���� parameter model
		assertModel("ref", "data");	// �ڵ���� @ModelAttribute method
		assertThat(getModelAndView().getModel().size(), is(5)); // BindResult�� �ڵ����
